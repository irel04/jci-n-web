...
function Header() {
	...
	return (
		<header className={`absolute flex py-2 px-4 items-center font-header gap-4 shadow w-full h-20 z-10 bg-white transition-transform duration-200 ease-out ${isTopPosition ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}>
